...
<form class="form-horizontal" method="GET" action="db_connect.php" id="formulario_index">
   <div class="container">
        <div class="row-flow">
            <p></p>
            <div class="col-md-9">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">Ver Clientes Mayores de: </div>
                    ...
                    <div class="panel-footer">
                        <ul class="list-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="edad">Edad : </label>
                                <div class="col-sm-10"> <input name="edad" type="number" placeholder="Edad"> </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button class="btn btn-default" type="submit">Enviar</button>
